    ...
    >
      <div className="top-area">
        <div className="container">
          <div className="row gy-4 g-xl-5 g-xxl-3">
                ...
                <div className="footer-social-wrapper">
                  {settings?.social_data &&
                    settings?.social_data?.map((social_icon) => (
                      ...
                      >
                        <i className={`${social_icon?.icon} text-dark`}></i>
                      </a>
                    ))}
                </div>
              </div>
            ...
            <div className="col-md-6 col-lg-3">
              ...
              >
                ...
                <button
                  ...
                  className="ch-btn ch-primary-btn w-311"
                >
                  {translate("Subscribe")}
        ...
        <div className="copyright-area">
          <span className="copy-text">&copy; {settings?.copyright_text}</span>
        </div>
      </div>
    </footer>
  );
