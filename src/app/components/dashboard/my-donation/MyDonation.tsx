        ...
        <table className="w-full min-w-max table-auto text-left">
          <thead>
            <tr className="bg-auc-primary-color-300">
              ...
              <th className={`${thStyles} w-[220px] hidden min-992:table-cell`}>
                {translate("Campaign Name")}
              </th>
              <th className={`${thStyles} w-[200px] hidden min-992:table-cell`}>
              ...
              table_data?.data?.map((item: any) => {
                return (
                  <tr key={item.id}>
                      ...
                      <div>
                        <ul className="text-left  leading-8">
                          <li>
                            ...
                            :
                            <span className="inline-block ms-2">{item.id}</span>
                          </li>
                          <li>
                            <span className="font-semibold capitalize">
                              {translate("Campaign Name")}
                    ...
                    >
                      <Link to={`/campaigns/${item?.campaign?.slug}`}>
                        {item?.campaign?.title?.slice(0, 20)}
                      </Link>
                    </td>
