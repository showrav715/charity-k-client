...
export default function SmBlogCard({
  img,
  title_link,
  title,
  date,
  ...
  return (
    <Link to={title_link}>
      <div className="single-sm-blog-card">
        <div className="image-wrapper">
          <img  src={img} width={90} height={90} alt="sm blog image" />
        </div>
        ...
        <div className="sm-blog-content">
          ...
          <span className="date-link">
            <svg
              ...
              fill="none"
            >
              <g clipPath="url(#clip0_1726_8523)">
                <path
